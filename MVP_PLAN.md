...
*Goal: Ensure the application knows "where" and "what" it is planning for.*
...
- [ ] **Locations UI:**
    ...
    - *Bonus:* "Use Browser Location" helper button.
- [ ] **Telescope UI:**
...
*Goal: Provide immediate, actionable context upon opening the app.*
...
*Goal: Expose the core algorithm to the user in a readable timeline format.*
...
*Goal: Ensure the application feels like a complete product, even with a limited scope.*

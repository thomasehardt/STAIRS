...
# Mobile port note: ForecastData and TelescopeProfile are only ever used here
# as type hints (never instantiated or introspected) - both aliased to `Any`
# below rather than dragging in the rest of the API package. The actual
# scoring math below is untouched from services/api/src/astro_logic/scoring.py.
ForecastData = Any
TelescopeProfile = Any
